...
<div class="container">
    ...
    <div class="form-group my-3">
        ...
        <input type="text" class="form-control" name="codi" value="{{old('id') ?? $nou_taller->id}}" readonly>
    </div>
    <div class="form-group my-3">
    ...
    <div class="form-group my-3">
        ...
        <input type="text" class="form-control" name="proposat" value="{{old('proposat') ?? $nou_taller->creador}}" readonly>
    </div>
    <div class="form-group my-3">
        <label class="fw-bold" for="descripcio">Descripció:</label>
        <textarea class="form-control" name="descripcio" rows=4>{{old('descripcio')}}</textarea>
    ...
    <div class="container d-flex justify-content-between">
        ...
        <input type="button" class="btn btn-danger mb-3" value="Esborrar camps">
    </div>
    <div class="container d-flex justify-content-between">
